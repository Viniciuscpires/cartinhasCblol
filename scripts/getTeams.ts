...
//   const rankings =
//     allTeamsNames.standings?.[0]?.stages?.[0]?.sections?.[0]?.rankings;

//   rankings?.map(async (rank) => {
//     const { teams } = rank;
//     const teamInfo = await getTeamInfo(teams?.[0].slug);
//     return {
//       ...teams?.[0],
//       ...teamInfo,
//     };
...
//   const teamInfo = response?.data?.teams?.[0];
...
const allTeams = {
  standings: [
    {
      id: "109523641416750631",
      name: "Split 1 2023",
      slug: "cblol_2023_split_1",
      scores: [],
      split: {
        id: "109460726048638514",
      },
      season: {
        id: "109460648135670300",
        name: "2023",
        slug: "2023",
        status: "active",
        startTime: "2022-12-31T23:00:00Z",
        endTime: "2023-12-31T22:59:00Z",
        splits: [
          {
            id: "109460712659577070",
            name: "emea_regional_leagues_split_1",
            slug: "emea_regional_leagues_split_1",
            startTime: "2022-12-31T23:00:00Z",
            endTime: "2023-04-03T22:00:00Z",
          },
          {
            id: "109460726048638514",
            name: "cblol_split_1",
            slug: "cblol_split_1",
            startTime: "2023-01-18T23:00:00Z",
            endTime: "2023-04-16T22:00:00Z",
          },
          {
            id: "109460726048638515",
            name: "emea_regional_leagues_split_2",
            slug: "emea_regional_leagues_split_2",
            startTime: "2023-05-25T22:00:00Z",
            endTime: "2023-08-13T22:00:00Z",
          },
          {
            id: "109460739126880495",
            name: "lck_split_1",
            slug: "lck_split_1",
            startTime: "2023-01-15T23:00:00Z",
            endTime: "2023-04-10T22:00:00Z",
          },
          {
            id: "109460739126880496",
            name: "lcs_split_1",
            slug: "lcs_split_1",
          ...
          {
            id: "109460746442262068",
            name: "nacl_split_1",
            slug: "nacl_split_1",
            startTime: "2023-01-13T23:00:00Z",
            endTime: "2023-04-24T22:00:00Z",
          },
          {
            id: "109460749672102429",
            name: "lec_split_1",
            slug: "lec_split_1",
            startTime: "2023-01-18T23:00:00Z",
            endTime: "2023-02-27T23:00:00Z",
          },
          {
            id: "109460753935114954",
            name: "lla_split_1",
            slug: "lla_split_1",
            startTime: "2023-01-21T23:00:00Z",
            endTime: "2023-04-15T22:00:00Z",
          },
          {
            id: "109460756948372268",
            name: "msi_2023",
            slug: "msi_2023",
            startTime: "2023-04-28T22:00:00Z",
            endTime: "2023-05-22T22:00:00Z",
          },
          {
            id: "109460765662452357",
            name: "emea_masters_split_1",
            slug: "emea_masters_split_1",
            startTime: "2023-04-01T22:00:00Z",
            endTime: "2023-04-30T22:00:00Z",
          },
          {
            id: "109461328873331347",
            name: "challengers_emea_leagues_split_1",
            slug: "challengers_emea_leagues_split_1",
            startTime: "2023-01-06T23:00:00Z",
            endTime: "2023-03-13T23:00:00Z",
          },
          {
            id: "109461328873331348",
            name: "challengers_emea_leagues_split_2",
            slug: "challengers_emea_leagues_split_2",
            startTime: "2023-03-24T23:00:00Z",
            endTime: "2023-06-12T22:00:00Z",
          },
          {
            id: "109477479408145043",
            name: "challengers_oceania_split_1",
            slug: "challengers_oceania_split_1",
            startTime: "2023-01-18T23:00:00Z",
            endTime: "2023-03-14T23:00:00Z",
          },
          {
            id: "109505763038753458",
            name: "esports_special_events",
            slug: "esports_special_events",
            startTime: "2022-12-31T23:00:00Z",
            endTime: "2023-12-30T23:00:00Z",
          },
          {
            id: "109625572480696208",
            name: "lck_challengers_split_1",
            slug: "lck_challengers_split_1",
            startTime: "2023-01-13T23:00:00Z",
            endTime: "2023-04-09T22:00:00Z",
          },
          {
            id: "109659885917580730",
            name: "latam_regional_leagues_split_1",
            slug: "latam_regional_leagues_split_1",
            startTime: "2023-01-09T23:00:00Z",
            endTime: "2023-04-21T22:00:00Z",
          },
          {
            id: "109660593953910479",
            name: "challengers_br_split_1",
            slug: "challengers_br_split_1",
            startTime: "2023-01-09T03:00:00Z",
            endTime: "2023-03-31T03:00:00Z",
          },
          {
            id: "109664767090063451",
            name: "challengers_sea_leagues_split_1",
            slug: "challengers_sea_leagues_split_1",
            startTime: "2023-01-11T23:00:00Z",
            endTime: "2023-04-07T22:00:00Z",
          },
          {
            id: "109669595848211285",
            name: "lpl_split_1",
            slug: "lpl_split_1",
            startTime: "2023-01-11T23:00:00Z",
            endTime: "2023-03-30T22:00:00Z",
          },
          {
            id: "109675619108131936",
            name: "lco_split_1",
            slug: "lco_split_1",
            startTime: "2023-01-18T23:00:00Z",
            endTime: "2023-04-07T22:00:00Z",
          ...
          {
            id: "109704869903140699",
            name: "pcs_split_1",
            slug: "pcs_split_1",
            startTime: "2023-01-29T23:00:00Z",
            endTime: "2023-04-12T22:00:00Z",
          },
          {
            id: "109710200696819474",
            name: "ljl_split_1",
            slug: "ljl_split_1",
            startTime: "2023-01-25T23:00:00Z",
            endTime: "2023-04-17T22:00:00Z",
          },
          {
            id: "109710902902203116",
            name: "vct_lock_in_brazil",
            slug: "vct_lock_in_brazil",
            startTime: "2023-02-10T23:00:00Z",
            endTime: "2023-03-06T23:00:00Z",
          },
          {
            id: "109711258548898764",
            name: "vct_international_leagues",
            slug: "vct_international_leagues",
            startTime: "2023-03-23T23:00:00Z",
            endTime: "2023-05-30T22:00:00Z",
          },
          {
            id: "109715927210894666",
            name: "challengers_jpn_split_1",
            slug: "challengers_jpn_split_1",
            startTime: "2023-01-25T23:00:00Z",
            endTime: "2023-03-20T23:00:00Z",
          },
          {
            id: "109721580934915753",
            name: "challengers_kr_split_1",
            slug: "challengers_kr_split_1",
            startTime: "2023-01-23T23:00:00Z",
            endTime: "2023-02-26T23:00:00Z",
          },
          {
            id: "109749545559722257",
            name: "vcs_split_1",
            slug: "vcs_split_1",
            startTime: "2023-02-13T23:00:00Z",
            endTime: "2023-05-01T22:00:00Z",
          },
          {
            id: "109783022590325074",
            name: "challengers_na_split_1",
            slug: "challengers_na_split_1",
            startTime: "2023-01-29T23:00:00Z",
            endTime: "2023-03-20T23:00:00Z",
          },
        ],
                  ...
                  teams: [
                    {
                      ...
                      code: "LBR",
                      image:
                        "http://static.lolesports.com/teams/1643305707691_RXfNcFMU.png",
                      record: {
                        wins: 3,
                        ties: 0,
                        losses: 4,
                  ...
                  teams: [
                    {
                      ...
                      code: "FUR",
                      image:
                        "http://static.lolesports.com/teams/FURIA---black.png",
                      record: {
                        wins: 2,
                        ties: 0,
                        losses: 5,
                  ...
                  teams: [
                    {
                      ...
                      code: "VKS",
                      image:
                        "http://static.lolesports.com/teams/1670542079678_vks.png",
                      record: {
                        wins: 1,
                        ties: 0,
                        losses: 7,
  ...
  teams: [
    {
      ...
      backgroundImage:
        "http://static.lolesports.com/teams/FuriaUppercutFUR.png",
      status: "active",
      homeLeague: {
        name: "CBLOL",
        region: "BRASIL",
